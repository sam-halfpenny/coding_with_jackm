...
class Snake:
    def __init__(self):
        ...
        self.body = [triangle(-20, 0), triangle(0, 0), triangle(20, 0)] # body is a list of squares
    ...
    def moveOneStep(self):
        if triangle(self.nextposition[0], self.nextposition[1]) not in self.body: 
            # attempt (unsuccessful) at collision detection
            self.body.append(triangle(self.nextposition[0], self.nextposition[1])) 
